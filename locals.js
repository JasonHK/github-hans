...
I18N.zh = {
    ...
    "pubilc": { // 公共區域翻譯
        "static": { // 靜態翻譯
            ...
            "Add a bulleted list": "新增無序列表",
            "Add a numbered list": "新增有序列表",
            "Add a task list": "新增任務列表",
            "Directly mention a user or team": "直接提到使用者或團隊",
            "Reference an issue or pull request": "參考問題或合併請求",
            "Leave a comment": "留下評論",

            "Attach files by dragging & dropping,": "拖曳新增附件，",
            "selecting them": "或選擇檔案",
            ", or pasting from the clipboard.": "，或複製貼上內容。",
            "Styling with Markdown is supported": "支援 Markdown 功能喔。",
    ...
    "page-dashboard": { // 已登入的首頁
        "static": { // 靜態翻譯
            ...
            "write comments, and open a pull request.": "寫評論，並建立一個合併請求。(教學內容就不翻譯了...)",
    ...
    "page-profile": { // 個人首頁
        "static": { // 靜態翻譯
            ...
            "contributions in private repositories": "次貢獻於私人倉庫",
            "Developer Program Member": "開發者企劃參與者",
            "Open": "開放中",
            "Closed": "已關閉",
    ...
    "page-account": { // 個人設定
        "static": { // 靜態翻譯
            ...
            "Your notification settings apply to the": "通知設定將應用到",
            ...
            "Revoke all": "註銷全部",
            "You have granted the following applications access to your account. Read more about connecting with third-party applications at": "您已授權下來應用訪問您的帳戶訊息，如需了解更多請閱讀",
            "Sort": "排序",
            "Sort by": "排序方式",
            "Alphabetical": "字母排序",
            "Recently used": "最近使用",
            ...
            "Something users will recognize and trust": "讓使用者辨識和信任",
            "Homepage URL": "首頁地址",
    ...
    "vis-public": { // 倉庫頁
        "static": { // 靜態翻譯
            ...
            "Clone with SSH": "透過 SSH 複製",
            "Clone with HTTPS": "透過 HTTPS 複製",
            ...
            "Furthest due date": "最遠的到期日",
            "Closest due date": "最近的到期日",
            "Least complete": "最少完成",
            "Most complete": "最多完成",
            "Most issues": "最多問題",
            "Least issues": "最少問題",
            ...
            "Filters": "篩選",
            "Open issues and pull requests": "開放的問題或合併請求",
            "Your issues": "您提出的問題",
            ...
            "Collaborators": "合作者",
            "Push access to the repository": "目前倉庫的推送權限",
            "This repository doesn’t have any collaborators yet. Use the form below to add a collaborator.": "目前倉庫沒有合作者，您可以在下面輸入框新增合作者。",
            "Search by username, full name or email address": "搜尋使用者名稱, 全名, 信箱地址：",
            "Add collaborator": "新增合作者",

            // Upload files 頁面
            "Drag files here to add them to your repository": "拖曳檔案新增到目前倉庫",
            "Drag additional files here to add them to your repository": "拖曳其他檔案新增到目前倉庫",
            ...
            "files": "",
            "Commit changes": "提交變更",
            "Add files via upload": "透過新增檔案上傳",
            "Optional extended description": "可選的描述",
            "Name your file…": "命名你的檔案⋯",
            "Add an optional extended description…": "新增描述⋯",
            ...
            // Pull Requests 頁面
            "There aren’t any open pull requests.": "暫無合併請求。",
            ...
            "Files changed": "更改的檔案",
            "commented": "評論於",
            "You’re receiving notifications because you’re subscribed to this thread.": "你會收到通知是因為你訂閱了此話題。",
            "You’re receiving notifications because you were assigned.": "你會收到該訊息是因為你是該問題的受理人。",
            "You’re not receiving notifications from this thread.": "你目前不會收到來自於此話題的通知。",
            "Subscribe": "訂閱",
            "Unsubscribe": "取消訂閱",
            "Lock conversation": "鎖定會話",
            "Lock conversation on this issue": "鎖定此問題的會話",
            "Locking the conversation means:": "鎖定此會話意味著：",
            "Other users can’t add new comments to this issue.": "沒有任何人可以對此問題發表評論。",
            "You and other members of teams with write access to this repository can still leave comments that others can see.": "你和其他擁有寫入權限的成員仍可在此留下評論。",
            ...
            "Add more commits by pushing to the": "新增更多來至於",
            "branch on": "分支的提交推送到",
            ...
            "GitHub Issues adds lightweight issue tracking tightly integrated with your repository. Add issues to milestones, label issues, and close & reference issues from commit messages.": "GitHub 與您的存儲庫新增輕量級問題跟蹤緊密整合的問題。新增里程碑的問題，標籤問題，並密切與參考問題提交消息。",

            "Merge button": "合併按鈕",
            "When merging pull requests, you can allow merge commits, squashing, or both.": "當合併合併請求時，您可以允許合併提交，壓縮。",
            ...
            "Default branch": "預設分支",
            "The default branch is considered the “base” branch in your repository, against which all pull requests and code commits are automatically made, unless you specify a different branch.": "預設分支被認為是“基地”分支在您的資料庫，對所有合併請求和程式碼的提交是自動進行的，除非您指定一個不同的分支。",
            "Update": "更新",
            ...
            // commits 頁面
            "committed": "提交於",
            "Merge pull request": "合併合併請求",
            "Confirm merge": "確認合併",
            "Close pull request": "關閉合併請求",
            ...
            "Attach binaries by dropping them here or": "拖曳檔案到這來新增附件",
    ...
    "homepage": { // 未登入首頁
        "static": { // 靜態翻譯
            ...
            "Host and manage your code on GitHub. You can keep your work private or share it with the world.": "主機和管理您的程式碼在 GitHub 上。您可以把您的工作或私人與世界分享。",
    ...
    "signup": { // 註冊頁
        "static": { // 靜態翻譯
            ...
            "Collaborative code review": "協作程式碼審查",
            "Issue tracking": "問題跟蹤",
    ...
    "issues": { // 問題頁面
        "static": { // 靜態翻譯
            ...
            "Organization": "組織",
            "Filter by organization or owner": "透過組織或所有者篩選",
    ...
    "search": { // 搜尋頁面
        "static": { // 靜態翻譯
            ...
            "and": "要",
            "only": "只",
            "including forks.": "包括被衍生的倉庫。",

            "Code options": "程式碼選項",
            "With this extension": "檔案後綴",
            "Of this file size": "檔案大小",
            "In this path": "檔案路徑",
            "Return code from forked repositories": "搜尋結果包括被衍生的倉庫。",
    ...
    "gist": { // 程式碼片段頁面
        "static": { // 靜態翻譯
            ...
            "Clone with Git or checkout with SVN using the repository's web address.": "Git 複製或 SVN 檢出該倉庫所使用的 web 地址。",
            "Clone with an SSH key and passphrase from your GitHub settings.": "使用 SSH 密鑰複製",
