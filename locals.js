...
     * 代碼高亮 hig​​hlight tab-size js-file-line-container
...
            "Add a bulleted list": "添加無序列表",
            "Add a numbered list": "添加有序列表",
            "Add a task list": "添加任務列表",
            "Directly mention a user or team": "直接提到用戶或團隊",
            "Reference an issue or pull request": "參考問題或拉取請求",
            "Leave a comment": "留下評論",

            "Attach files by dragging & dropping,": "拖拽添加附件，",
            "selecting them": "或選擇文件",
            ", or pasting from the clipboard.": "，或複制粘貼內容。",
...
            "Configure email settings": "修改電子郵件設置",
...
            "Switch dashboard context": "切換默認身份",
...
    "page-profile": { // 個人首頁
        "static": { // 靜態翻譯
            "Updating your profile with your name, location, and a profile picture helps other GitHub users get to know you.": "更新您的資料信息包括姓名，地址，頭像等資料，讓其他用戶更容易的了解您。" ,
...
            "Learn more about blocking a user.": "查看詳細的阻止用戶信息。",
            "Block or report this user": "阻止或舉報該用戶",
            "Block user": "阻止該用戶",
            "Hide content and notifications from this user.": "屏蔽所有來自該用戶的通知消息。",
            "Report abuse": "舉報該用戶",
            "Contact Support about this user's behavior.": "將該用戶行為上報。",
        },
        "regexp": [ // 正則翻譯
...
            "Contributions": "貢獻",
            "Include private contributions on my profile": "在我的主頁顯示私人貢獻",
            "Get credit for all your work by showing the number of contributions to private repositories on your profile without any repository or organization information.": "顯示所有包括私人倉庫的貢獻到您的個人資料頁面，不包括組織倉庫信息。" ,
            "Learn how we count contributions": "查看如統計貢獻",
            "Update contributions": "更新貢獻",

            "GitHub Developer Program": "GitHub 開發者計劃",
            "Building an application, service, or tool that integrates with GitHub?": "構建應用程序、服務或工具,集成了GitHub嗎？",
...
            "Change username": "修改用戶名",
            "Changing your username can have": "修改您的用戶名會導致",
...
            "will be used for account-related notifications (eg account changes and billing receipts) as well as any web-based GitHub operations (eg edits and merges).": "將被用於接收相關通知(例如：賬單信息)，以及任何基於web 的GitHub 操作(例如：編輯或合併操作)。",
            "Primary": "主帳戶",
            "Private": "私有",
            "Public": "公開",
            "This email will be used as the 'from' address for web-based GitHub operations.": "該郵箱將被用作 \"發件人\"地址",
...
            "We will use": "我們將使用",
            "when performing web-based Git operations and sending email on your behalf. If you want command line Git operations to use your private email you must": "作為默認\"發件人\"地址以您的名義發送電子郵件。如果您想在命令行Git 的操作中使用您的私人郵件地址，您必須在",
            "set your email in Git": "Git 中設置您的電子郵件地址",
            "Email preferences": "Email 偏好設置",
            "Receive all emails, except those I unsubscribe from.": "接收所有郵件，除了那些我退訂的信息。",
...
            "Learn more": "查看更多",
            "Only receive account related emails, and those I subscribe to.": "只接收帳戶相關的電子郵件，以及我的訂閱的信息。",
            "We'll only send you legal or administrative emails, and any emails you’ve specifically subscribed to.": "我們只向您發送法律或行政郵件以及您訂閱信息。",
            "Save email preferences": "保存偏好",
            "Successfully updated your email preferences.": "Email 偏好設置修改成功。",
            "Looking for activity notification controls? Check the": "想要了解更詳細的通知設置，請前往",

            // Notification center 菜單
            "How you receive notifications": "通知設置",
...
            "Your notification settings apply to the": "通知設置將應用到",
            "repositories you’re watching": "您關注的倉庫",
            "Notification email": "接收通知的郵箱",
            "Primary email address": "主郵箱地址",
            "Save": "保存",
            "Custom routing": "自定義",
...
            // Billing 菜單
            "Billing overview": "財務信息",
            "Plan": "方案",
            "Free": "免費",
            "Change plan": "修改方案",
            "per month for": "每月 -",
            "Learn more about Git LFS": "什麼是 Git LFS (大文件存儲)？",
            "Purchase more": "購買更多",
            "Billing cycle": "結算週期",
            "Bandwidth": "帶寬",
            "Bandwidth quota resets every billing cycle": "帶寬配額每個週期重置",
            "Storage": "存儲",
            "Payment": "支付方式",
            "No payment method on file.": "沒有設置支付方式",
...
            "Status:": "狀態:",
            "Off": "未開啟",
            "Set up two-factor authentication": "設置雙重認證",
            "provides another layer of security to your account.": "為您的帳戶提供了另一層安全保障。",
            "Sessions": "會話信息",
            "This is a list of devices that have logged into your account. Revoke any sessions that you do not recognize.": "這是您登陸的設備會話列表，如果不是您本人操作，可以關閉該會話。",
            "Your current session": "您當前的會話",
            "Location:": "地址",
            "Signed in:": "登陸於",
            "Last accessed on": "最後訪問時間",
            "Revoke": "註銷",
...
            "Revoke all": "註銷全部",
            "You have granted the following applications access to your account. Read more about connecting with third-party applications at": "您已授權下來應用訪問您的帳戶信息，如需了解更多請閱讀",
            "Sort": "排序",
            "Sort by": "排序方式",
            "Alphabetical": "字母排序",
            "Recently used": "最近使用",
...
            "Developer applications are used to access the": "開發者應用是用於訪問",
...
            "This is displayed to all potential users of your application": "給您的目標用戶最直接的信息",
            "Authorization callback URL": "認證回調地址",
            "Your application’s callback URL. Read our": "您的應用授權回調地址。詳情請閱讀",
...
            "Any user-specific information (OAuth tokens, SSH keys, Job Profile, etc) will be erased": "任何用戶特定的信息（OAuth tokens, SSH keys, Job Profile, 等）將被刪除。",
            "create a new personal account": "創建一個新的個人帳戶",
        },
        "regexp": [ // 正則翻譯
            [/This email will not be used as the 'from' address for web-based GitHub operations - we will instead use ([^@]+@users.noreply.github.com)./, "該郵箱不會被用作\"發件人\"地址，我們會改用($1) 作為默認\"發件人\"地址。"],
...
            [/You will no longer be able to sign into (\w+) \(all administrative privileges will be bestowed upon the owners you choose\)/, "您將不能作為賬戶登錄到$1。（所有管理權限將賦予您選擇的所有者）"],
            [/Any commits credited to (\w+) will no longer be linked to this GitHub account/, "任何提交歸功於 $1 將不再鏈接到這個 GitHub 帳戶"],
...
    "page-new-repo": { // 新建倉庫
        "static": { // 靜態翻譯
            "Create a new repository": "創建一個新的倉庫",
            "A repository contains all the files for your project, including the revision history.": "倉庫包含項目中的所有文件，包括修訂歷史記錄。",
            "Owner": "創建者",
            "Repository name": "倉庫名",
...
            "This will let you immediately clone the repository to your computer. Skip this step if you're importing an existing repository.": "這將讓您可以立刻克隆該倉庫到您的電腦。如果您要提交已有的倉庫，請忽略這個選項。",
            "Add .gitignore:": "添加 .gitignore 文件",
            "Filter ignores…": "篩選忽略文件…",
...
            "Import all the files, including the revision history, from another version control system.": "導入的所有文件，包括修訂歷史記錄，從另一個版本控制系統。",
...
            "There is no need to keep this window open, we’ll email you when the import is done.": "沒有必要在這個窗口傻等，當導入完成時，我們會向您發送電子郵件。",
...
            // 倉庫描述編輯
            "No description or website provided.": "沒有提供說明和網站信息.",
            "Edit": "編輯",
            "Description": "描述",
...
            "Clone with SSH": "通過 SSH 克隆",
            "Clone with HTTPS": "通過 HTTPS 克隆",
...
            "File uploading is now available": "現在可以上傳文件了",
            "You can now drag and drop files into your repositories.": "您可以直接拖拽文件到該倉庫界面進行上傳。",
            "Learn more": "查看詳情",
            "Dismiss": "我知道了",
...
            "Attach files by dragging & dropping,": "拖拽添加附件，",
            "selecting them": "或選擇文件，",
            ", or pasting from the clipboard.": "或複制黏貼內容。",
...
            "This repository doesn’t have any collaborators yet. Use the form below to add a collaborator.": "當前倉庫沒有合作者，您可以在下面輸入框添加合作者。",
            "Search by username, full name or email address": "搜索用戶名, 全名, 郵箱地址：",
...
            "This file is empty.": "這個文件是空的",
            "Something went really wrong, and we can’t process that file.": "遇到錯誤，我們處理不了這個文件。",
            "Uploading": "文件上傳中",
            "of": "",
            "files": "",
            "Commit changes": "提交變更",
            "Add files via upload": "通過添加文件上傳",
...
            "Use the links above to find what you’re looking for, or try": "使用上面的鏈接來找到您要找的，或者嘗試",
            "a new search query": "新的搜索查詢",
            ". The Filters menu is also super helpful for quickly finding issues most relevant to you.": "。搜索欄也是快速找到問題最相關的您超級有幫助的。",
...
            "Avoid bugs by automatically running your tests.": "通過持續集成測試來避免BUG。",
            "Continuous integration can help catch bugs by running your tests automatically.": "持續集成可以通過自動運行您的測試有助於捕獲錯誤。",
            "Merge your code with confidence using one of our continuous integration providers.": "合併您的代碼使用我們信任的持續集成供應商。",

            "Add more commits by pushing to the": "添加更多來至於",
            "branch on": "分支的提交推送到",
...
            "Rename": "重命名",
            "Features": "特性",
            "GitHub Wikis is a simple way to let others contribute content. Any GitHub user can create and edit pages to use for documentation, examples, support, or anything you wish.": "GitHub Wikis 是一個簡單的方法讓別人貢獻內容。 GitHub 的任何用戶都可以創建和編輯頁面中使用的文檔，示例，支持或任何您想。",
            "Restrict editing to collaborators only": "編輯限制只有合作者可以",
            "Public wikis will still be readable by everyone.": "公共 wikis 仍然會受到大家的可讀性",
            "GitHub Issues adds lightweight issue tracking tightly integrated with your repository. Add issues to milestones, label issues, and close & reference issues from commit messages.": "GitHub 與您的存儲庫添加輕量級問題跟踪緊密集成的問題。添加里程碑的問題，標籤問題，並密切與參考問題提交消息。",
...
            "GitHub Pages": "GitHub 項目演示頁面",
            "Your site is published at": "您的演示地址為:",
            "Your site is ready to be published at": "您的演示地址為:",
            "Update your site": "更新您的站點",
            "To update your site, push your HTML or": "更新您的站點，可以直接推送 html 或者使用",
            "updates to your": "更新到",
            "branch. Read the": "分支。詳情請閱讀",
            "Pages help article": "演示頁面幫助",
            "for more information.": "獲取更多信息",
            "Overwrite site": "覆蓋現有站點",
            "Replace your existing site by using our automatic page generator. Author your content in our Markdown editor, select a theme, then publish.": "通過使用我們的自動頁面生成器替換現有的網站。您可以在我們的Markdown編輯器，選擇一個主題，然後發布。",
...
            "Transfer": "轉讓",
            "Transfer this repository to another user or to an organization where you have admin rights.": "此存儲庫轉移到其他用戶或組織，在這裡您具有管理員權限。",
            "Delete this repository": "刪除此倉庫",
            "Once you delete a repository, there is no going back. Please be certain.": "一旦刪除您的倉庫，將無法找回。請您三思。",

            "Default branch": "默認分支",
            "The default branch is considered the “base” branch in your repository, against which all pull requests and code commits are automatically made, unless you specify a different branch.": "默認分支被認為是“基地”分支在您的資料庫，對所有拉取請求和代碼的提交是自動進行的，除非您指定一個不同的分支。",
            "Update": "更新",
            "Switch default branch": "選擇默認分支",
            "Filter branches": "搜索分支",
            "Protected branches": "受保護的分支",
            "Protect branches to disable force pushing, prevent branches from being deleted, and optionally require status checks before merging. New to protected branches?": "受保護分支禁用強制推送，避免刪除分支機構，合併可選要求前狀態檢查。創建新的受保護的分支機構？",
            "Learn more.": "查看更多信息",
...
            "Choose different branches or forks above to discuss and review changes.": "選擇不同的分支或派生來討論和查看變化。",
...
            "…or import code from another repository": "…或從另一個倉庫庫導入代碼",
...
            "Downloads": "下載",
            "Notes": "說明",
            "There aren’t any releases here": "沒有任何發佈內容",
            "Create a new release": "創建一個發布",
...
            "This will delete the information for this tag.": "將刪除該標籤的所有信息。",
            "Delete this tag": "刪除此標籤",
            "Your tag was removed": "標籤刪除成功！",

            "Existing tag": "已存在的標籤",
            "Markdown supported": "Markdown 語法支持",
            "Attach binaries by dropping them here or": "拖拽文件到這來添加附件",
...
            "Save draft": "保存草稿",
            "Saved!": "已保存",
            "Saving draft failed. Try again?": "保存失敗，再試一次？",
...
            [/Save (.+?) to your computer and use it in GitHub Desktop./, "使用 GitHub 桌面版，保存 $1 到您的電腦。"],
            [/([\d,]+) Open/, "$1 個開放的"],
            [/([\d,]+) Closed/, "$1 個關閉的"],
...
            "Create a password": "創建一個密碼",
            "Sign up for GitHub": "註冊 GitHub",

            "Use at least one letter, one numeral, and seven characters.": "密碼需要字母和數字組成的 7 位以上字符串。",
...
            "How people build software": "人們如何構建軟件",
            "Millions of developers use GitHub to build personal projects, support their businesses, and work together on open source technologies.": "數以百萬計的開發人員使用GitHub 建立個人項目，支持他們的企業，共同在開放源碼技術。",

            "Introducing unlimited": "引入無限制的",
            "private repositories": "私人倉庫",
            "All of our paid plans on GitHub.com now include unlimited private repositories.": "所有在我們 GitHub.com 上的付費用戶，我們將提供無限制的私人倉庫。",
            "Sign up": "註冊",
            "to get started or": "開始使用或",
            "read more about this change on our blog": "閱讀更多信息在我們的博客上",
...
            "From hobbyists to professionals, GitHub helps developers simplify the way they build software.": "從業餘愛好者到專業人士，GitHub 幫助開發人員簡化的方式構建軟件。",
...
            "With hundreds of integrations, GitHub is flexible enough to be at the center of your development process.": "成百上千的集成，GitHub 是足夠靈活的，能夠在您的發展過程的中心。",

            "Who uses GitHub?": "誰在使用 GitHub ?",
            "Individuals": "個人",
            "Use GitHub to create a personal project, whether you want to experiment with a new programming language or host your life's work.": "使用GitHub 來創建一個個人項目，不管您想要嘗試一個新的編程語言或主機在您生活及工作。",
            "Communities": "社區",
            "GitHub hosts one of the largest collections of open source software. Create, manage, and work on some of today's most influential technologies.": "GitHub 主機是最大的開放源碼軟件的集合之一。創建，管理，以及在一些當今最具影響力的技術工作。",
            "Businesses": "企業",
            "Businesses of all sizes use GitHub to support their development process and securely build software.": "各種規模的企業使用的 GitHub 支持其發展過程中，安全地構建軟件。",
...
    "session-authentication": { // 登錄頁
        "static": { // 靜態翻譯
            "Sign in to GitHub": "登錄 GitHub 帳戶",
            "Username or email address": "用戶名/郵箱",
            "Password": "密碼",
            "Forgot password?": "忘記密碼",
            "Sign in": "登錄",
...
            "The best way to design, build, and ship software.": "最優的方式來設計、構建和存儲軟件",

            "Step 1:": "第一步:",
            "Set up a personal account": "建立個人賬戶",
            "Step 2:": "第二步:",
...
            // Step 1:
            "Create your personal account": "創建您的個人賬戶",
            "Username": "用戶名 (也是您個人首頁的二級地址)",
            "This will be your username — you can enter your organization’s username next.": "這將是您的用戶名 - 也可以是您組織或公司的名稱。",
            "Email Address": "Email 地址",
            "You will occasionally receive account related emails. We promise not to share your email with anyone.": "該郵箱用於接收相關的通知郵件。我們承諾不公開您的電子郵件給任何人。",
            "Password": "密碼",
            "Use at least one lowercase letter, one numeral, and seven characters.": "密碼需要字母和數字組成的 7 位以上字符串。",
            "By clicking on \"Create an account\" below, you are agreeing to the": "點擊下面的“創建賬戶”，表示您同意我們的",
            "Terms of Service": "服務條款",
            "and the": "和",
            "Privacy Policy": "隱私政策",
...
            "Organizations are separate from personal accounts and are best suited for businesses who need to manage permissions for many employees.": "組織是獨立於個人賬戶，是最適合需要管理權限對許多員工的企業。",
            "Learn more about organizations.": "閱讀更多關於組織的信息。",
            "Finish sign up": "完成註冊",
...
            "Depending on": "根據",
            "your notification settings": "您的通知設置",
            ", you’ll see updates here for your conversations in watched repositories.": "，您將看到您關注倉庫的更新信息。",
        },
        "regexp": [ // 正則翻譯
        ],
    },
...
            "Change notification settings": "修改通知設置",
        },
        "regexp": [ // 正則翻譯
        ],
    },
...
            "These are the organizations and developers building the hot tools today.": "這是今天創建熱門項目的組織和開發人員。",
            "These are the organizations and developers building the hot tools this week.": "這是本週創建熱門項目的組織和開發人員。",
            "These are the organizations and developers building the hot tools this month.": "這是本月創建熱門項目的組織和開發人員。",
...
        },
        "regexp": [ // 正則翻譯
            [/([\d,]+) stars today([^B]+)[\w ]+/, "今天 $1 贊$2創建者"],
            [/([\d,]+) stars this week([^B]+)[\w ]+/, "本週 $1 贊$2創建者"],
            [/([\d,]+) stars this month([^B]+)[\w ]+/, "本月 $1 贊$2創建者"],
        ],
    },
...
            "Browse popular repositories based on the topic that interests you most.": "瀏覽熱門倉庫基於你最感興趣的話題。",
...
            "a new search query": "新的搜索查詢",
            ". The Filters menu is also super helpful for quickly finding issues most relevant to you.": "。過濾菜單也是快速找到問題最相關的您超級有幫助的。",
            "ProTip!": "專業提示！",
...
            "In this path": "文件路徑",
            "Return code from forked repositories": "搜索結果包括被派生的倉庫。",
...
            "Soft wrap": "軟換​​行",
            "Add file": "添加文件",
            "Create secret gist": "創建私有片段",
            "Secret gists are hidden from search engines but visible to anyone you give the URL.": "私有片段搜索引擎是搜不到的，但是您可以分享您的 url 給他們。",
            "Create public gist": "創建公共片段",

            // All gists 頁面
            "Sort:": "排序:",
            "Sort opt​​ions": "排序選項",
            "Recently created": "最近創建的",
            "Least recently created": "最早創建的",
...
            "Clone with Git or checkout with SVN using the repository's web address.": "Git 克隆或 SVN 檢出該倉庫所使用的 web 地址。",
            "Clone with an SSH key and passphrase from your GitHub settings.": "使用 SSH 密鑰克隆",
...
            // 已贊頁面
            "Starred": "讚了",
            "You don’t have any starred gists yet.": "您還沒有贊過任何片段。",
        },
        "regexp": [ // 正則翻譯
...
            "Public data only": "僅公共數據",
            "Limited access to your public data": "僅限訪問您的公共數據",
            "This application will be able to identify you and read public information.": "此應用程序將能識別您的身份和讀取您的公共信息。",
            "Learn more": "更多",

            "Visit application’s website": "訪問應用官網",
            "Learn more about OAuth": "查看更多授權信息",
        },
        "regexp": [ // 正則翻譯
        ],
    },
